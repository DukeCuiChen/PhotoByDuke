...
//			.getExternalStorageDirectory().getPath() + "/PhotoDuke/appdata/";
	...
	public void initCacheDir(Context context) {
		...
		APP_CACHE_PATH = context.getCacheDir().toString() + "/";
	...
	synchronized CacheItem getFromCache(final String key) {
		...
		LogWrapper.logD("nowTime:" + System.currentTimeMillis());
		LogWrapper.logD("cacheTime:" + cacheItem.getTimeStamp());
